...
export default function SectionEleven() {
  return (
    <div className='flex flex-col md:flex-row justify-between 2xl:justify-around md:items-center mx-2 md:mx-20 2xl:mx-40 mt-10 bg-sky-700 text-white px-10 gap-y-10 2xl:px-40 py-24 rounded-2xl'>
